...
function ExploreCard(props: ExploreCardProps) {
  return (
    ...
    <Box sx={{ display: 'flex',
     ...
     width:(props.title==="Summer time at the library") ? "100%":{xs:"100%",sm:"100%",md:"650px",lg:"831px",},
     ...
     marginRight:"0",
      ...
      sx={{
        height:(props.title==="Summer time at the library") ? {xs:"auto",sm:"auto",md:"auto",lg:"320px",} :  {xs:"auto",sm:"auto",md:"auto",lg:"300px",},
        width:(props.title==="Summer time at the library") ? {sm:"150px",md:"auto",lg:"300px",}:{sm:"auto",md:"150px",lg:"434px",},
        display: "block",
      }}
        component="img"
